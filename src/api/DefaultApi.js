...
export default class DefaultApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the deleteChat operation.
     * @callback module:api/DefaultApi~deleteChatCallback
     ...
     * @param {module:api/DefaultApi~deleteChatCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/DefaultApi~getChatCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} [chatId] The unique identifier for the chat session
     * @param {module:api/DefaultApi~getChatCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Chat}
     */
    getChat(opts, callback) {
      opts = opts || {};
      let postBody = null;
     ...
     * @param {String} chatId The unique identifier for the chat session
     * @param {module:model/ChatMessage} chatMessage 
     ...
     * data is of type: {@link module:model/Chat}
     */
    sendMessage(chatId, chatMessage, callback) {
      ...
      if (chatMessage === undefined || chatMessage === null) {
        throw new Error("Missing the required parameter 'chatMessage' when calling sendMessage");
      }
    ...
    /**
     * Callback function to receive the result of the updateChat operation.
     * @callback module:api/DefaultApi~updateChatCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Update a chat
     * @param {String} chatId The unique identifier for the chat session
     * @param {module:model/Chat} chat 
     * @param {module:api/DefaultApi~updateChatCallback} callback The callback function, accepting three arguments: error, data, response
     */
    updateChat(chatId, chat, callback) {
      let postBody = chat;
      // verify the required parameter 'chatId' is set
      if (chatId === undefined || chatId === null) {
        throw new Error("Missing the required parameter 'chatId' when calling updateChat");
      }
      // verify the required parameter 'chat' is set
      if (chat === undefined || chat === null) {
        throw new Error("Missing the required parameter 'chat' when calling updateChat");
      }
     ...
     * @param {File} file 
     * @param {Object} opts Optional parameters
     * @param {Boolean} [temporary = false)] If set to true, the file will be stored temporarily and deleted after some time. If set to false, the file will be stored permanently. Temporary files cannot be indexed. They should be used in chats. 
